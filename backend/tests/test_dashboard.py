...
class TestDashboard:
    ...
    def test_dashboard_loads_successfully(self, auth_client, base_url):
    ...
    def test_dashboard_balance_calculation(self, auth_client, base_url):
    ...
    def test_dashboard_profit_loss_calculation(self, auth_client, base_url):
    ...
    def test_dashboard_stock_per_bag_type(self, auth_client, base_url):
    ...
    def test_dashboard_monthly_breakdown(self, auth_client, base_url):
    ...
    def test_dashboard_bank_transactions_list(self, auth_client, base_url):
